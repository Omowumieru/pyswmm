...
MODEL_POLLUTANTS_PATH_3 = os.path.join(
    DATA_PATH, "model_constantinflow_constanteffluent.inp"
)
...
if sys.maxsize > 2**32:
    WIN_SWMM_LIB_PATH = os.path.join(DATA_PATH, "..\\..\\lib\\windows", "swmm5-x64.dll")
else:
    WIN_SWMM_LIB_PATH = os.path.join(DATA_PATH, "..\\..\\lib\\windows", "swmm5.dll")
